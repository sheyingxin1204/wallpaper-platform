...
export async function getPublishedWallpapers(input: {
  ...
  try {
    ...
    console.error("Failed to load published wallpapers", error);
    return { items: [] as PublicWallpaperCard[], hasNext: false };
  }
}
...
export async function getPublishedWallpaperBySlug(slug: string): Promise<PublicWallpaperDetail | null> {
  ...
  try {
    ...
    console.error("Failed to load published wallpaper", error);
    return null;
  }
}
...
export async function getPublishedAsset(wallpaperId: string, kind: PublicAssetKind) {
  ...
  try {
    ...
    console.error("Failed to load published asset", error);
    return null;
  }
}
